# cwm-codes-standards-interpretation

**Domain:** Regulation, Compliance & Workforce → codes

**Mission:** Utility-specific code interpretation w/ precedent

## Background
Interprets utility-specific codes / tariffs using NLP + knowledge representation. Surfaces overlapping standards and jurisdictional precedent.
