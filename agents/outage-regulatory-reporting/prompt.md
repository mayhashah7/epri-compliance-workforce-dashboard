# cwm-outage-regulatory-reporting

**Domain:** Regulation, Compliance & Workforce → outage_reg

**Mission:** PUC / state-commission outage reports

## Background
Auto-generates regulatory outage reports from OMS, customer complaints, and restoration logs. Calculates reliability metrics per state-commission templates.
