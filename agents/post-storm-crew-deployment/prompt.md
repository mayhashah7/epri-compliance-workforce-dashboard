# cwm-post-storm-crew-deployment

**Domain:** Regulation, Compliance & Workforce → deployment

**Mission:** Optimal post-storm crew + materials routing

## Background
Optimizes post-storm crew deployment using damage model, crew skills, equipment availability, and accessibility (road blockages).
