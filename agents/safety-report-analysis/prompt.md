# cwm-safety-report-analysis

**Domain:** Regulation, Compliance & Workforce → safety

**Mission:** Near-miss + incident pattern detection

## Background
Mines safety reports for recurring near-miss patterns, environmental triggers, and crew-level risk factors. Recommends pre-job briefing emphasis.
