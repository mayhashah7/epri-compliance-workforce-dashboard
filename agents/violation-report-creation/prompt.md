# cwm-violation-report-creation

**Domain:** Regulation, Compliance & Workforce → violations

**Mission:** Auto-drafted NERC violation self-reports

## Background
Drafts compliance violation reports from operational data + audit findings, filling regulatory templates with citations and timelines.
