...
ORCHESTRATOR_NAME = "cwm-orchestrator"

# Full AMI agent fabric (12 total: orchestrator + 11 specialists)
AGENT_ROSTER = [
    {"name": "cwm-orchestrator", "domain": "routing", "icon": "📋", "color": "#f43f5e"},
    {"name": "cwm-compliance-doc-retrieval", "domain": "regdocs", "icon": "📚", "color": "#fb7185"},
    {"name": "cwm-violation-report-creation", "domain": "violations", "icon": "📝", "color": "#f43f5e"},
    {"name": "cwm-outage-regulatory-reporting", "domain": "outage_reg", "icon": "📊", "color": "#e11d48"},
    {"name": "cwm-codes-standards-interpretation", "domain": "codes", "icon": "⚖️", "color": "#dc2626"},
    {"name": "cwm-virtual-training-assistant", "domain": "training", "icon": "🎓", "color": "#a855f7"},
    {"name": "cwm-engineering-knowledge-retrieval", "domain": "engineering", "icon": "🔬", "color": "#06b6d4"},
    {"name": "cwm-training-course-creation", "domain": "course", "icon": "📖", "color": "#22d3ee"},
    {"name": "cwm-field-experience-synthesis", "domain": "field_xp", "icon": "🧰", "color": "#10b981"},
    {"name": "cwm-safety-report-analysis", "domain": "safety", "icon": "🦺", "color": "#f59e0b"},
    {"name": "cwm-post-storm-crew-deployment", "domain": "deployment", "icon": "🚚", "color": "#ef4444"},
]
...
class FoundryAgentRunner:
    ...
    async def _mock_chat(self, *, text: str, persona: str | None, case_id: str | None) -> AsyncIterator[dict]:
        ...
        _routes = [
            (["compliance", "retrieval"], "regdocs", "cwm-compliance-doc-retrieval"),
            (["violation", "report", "creation"], "violations", "cwm-violation-report-creation"),
            (["outage", "regulatory", "reporting"], "outage_reg", "cwm-outage-regulatory-reporting"),
            (["codes", "standards", "interpretation"], "codes", "cwm-codes-standards-interpretation"),
            (["virtual", "training", "assistant"], "training", "cwm-virtual-training-assistant"),
            (["engineering", "knowledge", "retrieval"], "engineering", "cwm-engineering-knowledge-retrieval"),
            (["training", "course", "creation"], "course", "cwm-training-course-creation"),
            (["field", "experience", "synthesis"], "field_xp", "cwm-field-experience-synthesis"),
            (["safety", "report", "analysis"], "safety", "cwm-safety-report-analysis"),
            (["post", "storm", "crew", "deployment"], "deployment", "cwm-post-storm-crew-deployment"),
        ]
        kind, target = "regdocs", "cwm-compliance-doc-retrieval"
...
EVENT_TO_PROMPT: dict[str, tuple[str, str]] = {
    "nerc-question": ("What does CIP-013-2 say about supply-chain risk?", "cwm-compliance-doc-retrieval"),
    "violation-draft": ("Draft a self-report for the PRC-005 missed maintenance", "cwm-violation-report-creation"),
    "outage-report": ("Generate the May major-event-day filing for PUC", "cwm-outage-regulatory-reporting"),
    "code-conflict": ("Reconcile NESC vs IEEE 516 on hot-stick clearance", "cwm-codes-standards-interpretation"),
    "crew-question": ("How do I isolate a faulted feeder during back-feed conditions?", "cwm-virtual-training-assistant"),
    "course-create": ("Build a 4-hour course on URD splicing from manual M-118", "cwm-training-course-creation"),
    "safety-pattern": ("Find recurring near-miss patterns in last 90 days", "cwm-safety-report-analysis"),
    "storm-deploy": ("Plan crew deployment for 380 outages across 14 districts", "cwm-post-storm-crew-deployment"),
}
